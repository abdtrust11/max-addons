...
class PurchaseOrderLine(models.Model):
    ...
    def _compute_amount(self):
        for line in self:
            ...
            if line.discount_fixed == 0:
                line.discount = 0
            if line.discount_fixed and line.product_qty :
                percent = 100* line.discount_fixed / line.product_qty
            ...
            if price_unit:
                ...
                line.price_subtotal = (line.product_qty*line.price_unit) -(line.discount_fixed*line.price_unit)

    discount = fields.Float(
        string='Discount (%)',digits = dp.get_precision('Product Unit of Measure'),
    )
    discount_fixed = fields.Float(
        string='Qty Discount ', digits=dp.get_precision('Discount'),
    )
    ...
    def _get_discounted_price_unit(self):
        ...
        self.ensure_one()
        if self.discount:
            print(self.price_unit * (1 - self.discount / 100))
